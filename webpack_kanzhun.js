...
//called key object
// error: 12210's code is associated with other modules code
// console.log(getSign(12210))


function encrypt123(){
h = {}
//kiv
h['kiv'] = getSign(12210)._A()

//b
n = '{"encCompanyId":"0nx_3g~~"}'
h['b'] = getSign(12210).mA(n, {iv: h['kiv']}).replace(/\//g, "_").replace(/\+/g, "-").replace(/=/g, "~")
return h;
}

console.log(encrypt123());